...
public class AcrobaticsEnchantment extends Enchantment{
    ...
    public AcrobaticsEnchantment(Rarity rarityIn, EnchantmentType typeIn, EquipmentSlotType[] slots) {
    ...
    public static class SpeedEquip {
        ...
        public static void doStuff(TickEvent.PlayerTickEvent event) {
            ...
            if (EnchantmentHelper.getEnchantmentLevel(EnchantHandler.ACROBATICS.get(), playerIn.getItemStackFromSlot(EquipmentSlotType.FEET)) == 1) {
                playerIn.addPotionEffect(new EffectInstance(Effects.JUMP_BOOST, 10, 4,true,false));
            }
        }
